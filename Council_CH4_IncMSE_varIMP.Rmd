...
#**Final model for AMF Council paper ** 
```{r}
...
df_cc = df[complete.cases(df$FCH4, df$TA, df$WD, df$WD_Cardinal, df$RH, df$NETRAD, df$WS, df$TS_3_1_1, df$SWC_3_1_1, df$H, df$LE, df$VPD, df$G_1_1_1),]
...
boruta = Boruta(FCH4 ~ TA + RH + NETRAD + WS + WD + TS_3_1_1 + SWC_3_1_1 + VPD + LE + H + G_1_1_1 + TS_SWC_interact, data = df_cc, doTrace = 2,maxRuns = 100)
boruta$finalDecision #indicates all above are confirmed important variables via a list 
plot(boruta,las = 2) 
...
site.fch4_full.cc <- randomForest(FCH4 ~ TA + RH + NETRAD + WS + WD + TS_3_1_1 + SWC_3_1_1 + VPD + LE + H + G_1_1_1 + TS_SWC_interact,
                             data = df_cc,
                             ntree = 950,
                             importance = TRUE)


 vif_model <- lm(FCH4 ~ TA + RH + NETRAD + WS + WD + TS_3_1_1 + SWC_3_1_1 + VPD + LE + H + G_1_1_1 + TS_SWC_interact, data = df_cc)
# 
 vif(vif_model) 
# TA              RH          NETRAD              WS              WD 
#       11.666473        3.477369        7.600407        1.242094        1.125224 
#        TS_3_1_1       SWC_3_1_1             VPD              LE               H 
#       28.733629        1.934511        9.584043        6.068455        7.334602 
#         G_1_1_1 TS_SWC_interact 
#        4.874390       20.286536 

# Extract variable importance
importance_values <- importance(site.fch4_full.cc, type = 1)  # type = 1 for %IncMSE

# Print the importance values
print(importance_values)

# Plot the importance values
varImpPlot(site.fch4_full.cc, type = 1, main = "CH4: Variable Importance (%IncMSE)")
...
# H                71.28700
# G_1_1_1          56.94895
# TS_SWC_interact  39.22236


```

#reduced site model 1 - removing TS-SWC interact term 
```{r}
#removing highest VIF from full mode, TS_SWC interact 
site.fch4_1.cc <- randomForest(FCH4 ~ TA + RH + NETRAD + WS + WD + TS_3_1_1 + SWC_3_1_1 + VPD + LE + H + G_1_1_1,
                             data = df_cc,
                             ntree = 950,
                             importance = TRUE)


 vif_model <- lm(FCH4 ~ TA + RH + NETRAD + WS + WD + TS_3_1_1 + SWC_3_1_1 + VPD + LE + H + G_1_1_1, data = df_cc)
# 
 vif(vif_model) 
#        TA        RH    NETRAD        WS        WD  TS_3_1_1 SWC_3_1_1       VPD        LE 
# 11.549342  3.424897  7.600275  1.242028  1.122197  7.610195  1.707529  9.569989  5.717050 
#         H   G_1_1_1 
#  7.085111  4.819605 

# Extract variable importance
importance_values <- importance(site.fch4_1.cc , type = 1)  # type = 1 for %IncMSE

# Print the importance values
print(importance_values)

# Plot the importance values
varImpPlot(site.fch4_1.cc , type = 1, main = "CH4: Variable Importance (%IncMSE)")
...
```{r}
#removing highest VIF from full mode, TS_SWC interact 
site.fch4_2.cc <- randomForest(FCH4 ~ RH + NETRAD + WS + WD + TS_3_1_1 + SWC_3_1_1 + VPD + LE + H + G_1_1_1,
                             data = df_cc,
                             ntree = 950,
                             importance = TRUE)


 vif_model <- lm(FCH4 ~  RH + NETRAD + WS + WD + TS_3_1_1 + SWC_3_1_1 + VPD + LE + H + G_1_1_1, data = df_cc)

 vif(vif_model) 
 #       RH    NETRAD        WS        WD  TS_3_1_1 SWC_3_1_1       VPD        LE         H 
 # 2.983660  7.220339  1.241772  1.109561  5.875643  1.616458  7.687104  5.706980  6.817040 
 #  G_1_1_1 
 # 4.131250 

# Extract variable importance
importance_values <- importance(site.fch4_2.cc , type = 1)  # type = 1 for %IncMSE

# Print the importance values
print(importance_values)

# Plot the importance values
varImpPlot(site.fch4_2.cc , type = 1, main = "CH4: Variable Importance (%IncMSE)")
...
```{r}
#removing highest VIF from full mode, TS_SWC interact 
site.fch4_3.cc <- randomForest(FCH4 ~ RH + NETRAD + WS + WD + TS_3_1_1 + SWC_3_1_1 + LE + H + G_1_1_1,
                             data = df_cc,
                             ntree = 950,
                             importance = TRUE)


 vif_model <- lm(FCH4 ~  RH + NETRAD + WS + WD + TS_3_1_1 + SWC_3_1_1 + LE + H + G_1_1_1, data = df_cc)

 vif(vif_model) 
 #       RH    NETRAD        WS        WD  TS_3_1_1 SWC_3_1_1        LE         H   G_1_1_1 
 # 1.223295  7.105379  1.230632  1.108897  4.182952  1.582525  5.545459  6.317353  3.357566 

# Extract variable importance
importance_values <- importance(site.fch4_3.cc , type = 1)  # type = 1 for %IncMSE

# Print the importance values
print(importance_values)

# Plot the importance values
varImpPlot(site.fch4_3.cc , type = 1, main = "CH4: Variable Importance (%IncMSE)")
...
```
#reduced site model 4 - removing TS-SWC interact, TA, VPD, NETRAD
```{r}
#removing highest VIF from full mode, TS_SWC interact 
site.fch4_4.cc <- randomForest(FCH4 ~ RH + WS + WD + TS_3_1_1 + SWC_3_1_1 + LE + H + G_1_1_1,
                             data = df_cc,
                             ntree = 950,
                             importance = TRUE)


 vif_model <- lm(FCH4 ~  RH + WS + WD + TS_3_1_1 + SWC_3_1_1 + LE + H + G_1_1_1, data = df_cc)

 vif(vif_model) 
 #       RH        WS        WD  TS_3_1_1 SWC_3_1_1        LE         H   G_1_1_1 
 # 1.223106  1.220275  1.105163  4.176765  1.531102  4.672512  3.651862  3.355744 
 
# Extract variable importance
importance_values <- importance(site.fch4_4.cc , type = 1)  # type = 1 for %IncMSE

# Print the importance values
print(importance_values)

# Plot the importance values
varImpPlot(site.fch4_4.cc , type = 1, main = "CH4: Variable Importance (%IncMSE)")
...
```
#reduced site model 5 - removing TS-SWC interact, TA, VPD, NETRAD, LE
```{r}
#removing highest VIF from full mode, TS_SWC interact 
site.fch4_5.cc <- randomForest(FCH4 ~ RH + WS + WD + TS_3_1_1 + SWC_3_1_1 + H + G_1_1_1,
                             data = df_cc,
                             ntree = 950,
                             importance = TRUE)


 vif_model <- lm(FCH4 ~  RH + WS + WD + TS_3_1_1 + SWC_3_1_1 + H + G_1_1_1, data = df_cc)

 vif(vif_model) 
 #       RH        WS        WD  TS_3_1_1 SWC_3_1_1         H   G_1_1_1 
 # 1.181981  1.091866  1.090422  3.914881  1.513789  1.916425  3.331414 
 
# Extract variable importance
importance_values <- importance(site.fch4_5.cc , type = 1)  # type = 1 for %IncMSE

# Print the importance values
print(importance_values)

# Plot the importance values
varImpPlot(site.fch4_5.cc , type = 1, main = "CH4: Variable Importance (%IncMSE)")
...
```
#reduced site model 6 - removing TS-SWC interact, TA, VPD, NETRAD, LE, TS_3
```{r}
#removing highest VIF from full mode, TS_SWC interact 
site.fch4_6.cc <- randomForest(FCH4 ~ RH + WS + WD + SWC_3_1_1 + H + G_1_1_1,
                             data = df_cc,
                             ntree = 950,
                             importance = TRUE)


 vif_model <- lm(FCH4 ~  RH + WS + WD + SWC_3_1_1 + H + G_1_1_1, data = df_cc)

 vif(vif_model) 
 #       RH        WS        WD SWC_3_1_1         H   G_1_1_1 
 # 1.178018  1.089946  1.067877  1.102029  1.826196  1.781593 
 
# Extract variable importance
importance_values <- importance(site.fch4_6.cc , type = 1)  # type = 1 for %IncMSE

# Print the importance values
print(importance_values)

# Plot the importance values
varImpPlot(site.fch4_6.cc , type = 1, main = "CH4: Variable Importance (%IncMSE)")
...
#reduced site model 7 - removing TS-SWC interact, TA, VPD, NETRAD, LE, swapping out G for TS_3
```{r}
#removing highest VIF from full mode, TS_SWC interact 
site.fch4_7.cc <- randomForest(FCH4 ~ RH + WS + WD + SWC_3_1_1 + H + TS_3_1_1,
                             data = df_cc,
                             ntree = 950,
                             importance = TRUE)


 vif_model <- lm(FCH4 ~  RH + WS + WD + SWC_3_1_1 + H + TS_3_1_1, data = df_cc)

 vif(vif_model) 
 #        RH        WS        WD SWC_3_1_1         H  TS_3_1_1 
 # 1.181981  1.086559  1.089222  1.368081  1.752837  2.093622 
 
# Extract variable importance
importance_values <- importance(site.fch4_7.cc , type = 1)  # type = 1 for %IncMSE

# Print the importance values
print(importance_values)

# Plot the importance values
varImpPlot(site.fch4_7.cc , type = 1, main = "CH4: Variable Importance (%IncMSE)")
...
```{r}
#removing highest VIF from full mode, TS_SWC interact 
site.fch4_6.cc_final <- randomForest(FCH4 ~ RH + WS + WD + SWC_3_1_1 + H + G_1_1_1,
                             data = df_cc,
                             ntree = 950,
                             importance = TRUE)
...
# Extract variable importance
importance_values <- importance(site.fch4_6.cc_final , type = 1)  # type = 1 for %IncMSE

# Print the importance values
print(importance_values)

# Plot the importance values
varImpPlot(site.fch4_6.cc_final , type = 1, main = "CH4: Variable Importance (%IncMSE)")
...
imp <- importance(site.fch4_6.cc_final, type = 1)
imp_df <- data.frame(
...
#plot
CH4_incMSE <- ggplot(imp_df, aes(x = reorder(Variable, IncMSE), y = IncMSE)) +
 geom_point(size = 5, pch = 1, stroke = 1.5) + #stroke changes thickness of circle shape 
  coord_flip() +
  labs(
    x = "",
    y = "%IncMSE",
    title = "CH4: Variable Importance"
  ) +
  theme_bw() +
 theme(
...
ggsave("C:/Users/kkent/Documents/Github Flux Network/Council_Flux_Analysis_Paper/Council Figures/CH4_incMSE_siteData.png",CH4_incMSE,

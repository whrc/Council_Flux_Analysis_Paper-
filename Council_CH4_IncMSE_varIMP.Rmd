...
df_cc = df[complete.cases(df$FCH4, df$TA, df$WD, df$WD_Cardinal, df$RH, df$SW_IN, df$WS, df$TS_3_1_1, df$SWC_3_1_1, df$H, df$LE, df$VPD, df$G_1_1_1),]

sum(is.na(df_cc$FCH4))
...
boruta = Boruta(FCH4 ~ TA + RH + SW_IN + WS + WD + TS_3_1_1 + SWC_3_1_1 + VPD + LE + H + G_1_1_1 + TS_SWC_interact, data = df_cc, doTrace = 2,maxRuns = 100)
boruta$finalDecision #indicates all above are confirmed important variables via a list 
plot(boruta,las = 2) 
...
site.fch4_full.cc <- randomForest(FCH4 ~ TA + RH + SW_IN + WS + WD + TS_3_1_1 + SWC_3_1_1 + VPD + LE + H + G_1_1_1 + TS_SWC_interact,
                             data = df_cc,
                             ntree = 950,
                             importance = TRUE)


 vif_model <- lm(FCH4 ~ TA + RH + SW_IN + WS + WD + TS_3_1_1 + SWC_3_1_1 + VPD + LE + H + G_1_1_1 + TS_SWC_interact, data = df_cc)
# 
 vif(vif_model) 
# TA              RH           SW_IN              WS              WD 
#       11.676439        3.480829        5.928052        1.238634        1.125417 
#        TS_3_1_1       SWC_3_1_1             VPD              LE               H 
#       29.395635        2.074002        9.658635        5.884591        6.413183 
...
site.fch4_1.cc <- randomForest(FCH4 ~ TA + RH + SW_IN + WS + WD + TS_3_1_1 + SWC_3_1_1 + VPD + LE + H + G_1_1_1,
                             data = df_cc,
                             ntree = 950,
                             importance = TRUE)


 vif_model <- lm(FCH4 ~ TA + RH + SW_IN + WS + WD + TS_3_1_1 + SWC_3_1_1 + VPD + LE + H + G_1_1_1, data = df_cc)
# 
 vif(vif_model) 
#       TA        RH     SW_IN        WS        WD  TS_3_1_1 SWC_3_1_1       VPD        LE 
# 11.516612  3.430826  5.897088  1.238458  1.122145  7.774829  1.814669  9.639517  5.601398 
#         H   G_1_1_1 
#  6.036386  4.814063 
...
```{r}
#removing highest VIF from full mode, TS_SWC interact 
site.fch4_2.cc <- randomForest(FCH4 ~ RH + SW_IN + WS + WD + TS_3_1_1 + SWC_3_1_1 + VPD + LE + H + G_1_1_1,
                             data = df_cc,
                             ntree = 950,
                             importance = TRUE)


 vif_model <- lm(FCH4 ~  RH + SW_IN + WS + WD + TS_3_1_1 + SWC_3_1_1 + VPD + LE + H + G_1_1_1, data = df_cc)

 vif(vif_model) 
 #       RH     SW_IN        WS        WD  TS_3_1_1 SWC_3_1_1       VPD        LE         H 
 # 3.003578  5.618215  1.238348  1.106277  5.939294  1.702753  7.886631  5.595011  5.845761 
 #  G_1_1_1 
 # 4.130348 
...
```{r}
#removing highest VIF from full mode, TS_SWC interact 
site.fch4_3.cc <- randomForest(FCH4 ~ RH + SW_IN + WS + WD + TS_3_1_1 + SWC_3_1_1 + LE + H + G_1_1_1,
                             data = df_cc,
                             ntree = 950,
                             importance = TRUE)


 vif_model <- lm(FCH4 ~  RH + SW_IN + WS + WD + TS_3_1_1 + SWC_3_1_1 + LE + H + G_1_1_1, data = df_cc)

 vif(vif_model) 
 #   RH     SW_IN        WS        WD  TS_3_1_1 SWC_3_1_1        LE         H   G_1_1_1 
 # 1.224767  5.388888  1.227958  1.105180  4.176768  1.684529  5.477819  5.257404  3.356525 
...
```
#reduced site model 4 - removing TS-SWC interact, TA, VPD, LE
```{r}
#removing highest VIF from full mode, TS_SWC interact 
site.fch4_4.cc <- randomForest(FCH4 ~ RH + SW_IN + WS + WD + TS_3_1_1 + SWC_3_1_1 + H + G_1_1_1,
                             data = df_cc,
                             ntree = 950,
                             importance = TRUE)


 vif_model <- lm(FCH4 ~  RH + SW_IN + WS + WD + TS_3_1_1 + SWC_3_1_1 + H + G_1_1_1, data = df_cc)

 vif(vif_model) 
 #      RH     SW_IN        WS        WD  TS_3_1_1 SWC_3_1_1         H   G_1_1_1 
 # 1.195296  4.596655  1.095052  1.092963  3.953988  1.610703  4.723270  3.338744 
...
#reduced site model 5 - removing TS-SWC interact, TA, VPD, LE, SW_IN
```{r}
#removing highest VIF from full mode, TS_SWC interact 
...
```
#reduced site model 6 - removing TS-SWC interact, TA, VPD, SW_IN, LE, TS_3
```{r}
#removing highest VIF from full mode, TS_SWC interact 
...
#reduced site model 7 - removing TS-SWC interact, TA, VPD, SW_IN, LE, swapping out G for TS_3
```{r}
#removing highest VIF from full mode, TS_SWC interact 

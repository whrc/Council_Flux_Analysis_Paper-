...
####Flux v Environmental correlation matrix 
```{r}
...
#save
ggsave("C:/Users/kkent/Documents/Github Flux Network/Council_Flux_Analysis_Paper/Council Figures/flux_correlation_matrix_allyears.png", 
       width = 7, height = 5, dpi = 600)
```
#Correlation matrix - adj color breaks and adding values to the tiles 
```{r}
# Option 1: Regular breaks from -1 to 1
ggplot(cor_long, aes(x = Var1, y = Var2, fill = Correlation)) +
  geom_tile() +
  # Add correlation values to tiles
  ...
  scale_fill_gradient2(low = "red", 
                      ...
                      midpoint = 0,
                      limits = c(-1, 1),
                      breaks = seq(-1, 1, by = 0.2)) +  # Creates breaks every 0.2
  theme_bw() +
  theme(axis.text.x = element_text(angle = 45, hjust = 1),
        axis.text = element_text(size = 12, face = "bold"),
        plot.title = element_text(size = 14, face = "bold", hjust = 0.5)) +                 
...
# Option 2: Custom breaks at key values - can make figure look a bit clunky 
ggplot(cor_long, aes(x = Var1, y = Var2, fill = Correlation)) +
  geom_tile() +
  # Add correlation values with conditional formatting
  geom_text(aes(label = sprintf("%.2f", Correlation),
...
# Option 3: Fewer breaks for a cleaner look, only labels corr values above 0.3
ggplot(cor_long, aes(x = Var1, y = Var2, fill = Correlation)) +
  geom_tile() +
...
#save
ggsave("C:/Users/kkent/Documents/Github Flux Network/Council_Flux_Analysis_Paper/Council Figures/flux_correlation_matrix_allyears2.png", 
       width = 7, height = 5, dpi = 600)


#Option 4: simple heatmap style correlation matrix visual 

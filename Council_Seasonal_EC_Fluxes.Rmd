...
#create TIMESTAMP variable that is = to TIMESTAMP_END (currently the function is no longer working, not sure why, see workaround below)
...
combined_plot <- combined_plot & 
  #plot_annotation(
    #title = "Annual Flux Timeseries (2017-2022)",
...
# Then save it
ggsave("C:/Users/kkent/Documents/Github Flux Network/Council_Flux_Analysis_Paper/Council Figures/combined_annual_timeseries.png", combined_plot, width = 20, height = 20, dpi = 600)
...
# Then save it
ggsave("C:/Users/kkent/Documents/Github Flux Network/Council_Flux_Analysis_Paper/Council Figures/combined_seasonal_timeseries.png", combined_plot2, width = 20, height = 20, dpi = 600)
...
Monster_plot <- ggplot(data = df_avg) +
  ...
  scale_color_manual(
    name = "",
    values = c("15cm Soil Temperature" = "darkblue", "Air Temperature" = "salmon", "NEE" = "turquoise3", "NEE_GF" = "turquoise3", "ERA5 Air Temperature" = "darkgreen"))+

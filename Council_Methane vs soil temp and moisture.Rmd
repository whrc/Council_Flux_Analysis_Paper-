...
# First, let's create a dataset with complete cases
model_data <- df_era2 %>%
...
#hybrid approach 
```{r}
# Use mixed model for winter, XGBoost for other seasons
df_era2$hybrid_predictions <- df_era2$fch4_predicted  # Start with XGBoost predictions
winter_indices <- df_era2$season == "Winter"
df_era2$hybrid_predictions[winter_indices] <- predict(winter_me_model, 
                                                     newdata = df_era2[winter_indices,])
```

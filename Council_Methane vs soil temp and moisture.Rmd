...
# 850	     43.94687			
# 950	     43.87470	
#However, we see improvement drops significantly after around 550/600 trees, so could likely use 550/600 trees just fine with little loss of accuracy
...
#Results: 
#optimal number of trees at 805, but with minimal improvement from 550 (2.124 → 2.120) --> Could likely use 550-600 trees without significant loss in accuracy

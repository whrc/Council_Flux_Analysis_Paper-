...
# First, let's create a list of all your temperature variables
...
# This second approach with model_comparisons will show you:
# 
...
# 
# This matches well with your moisture distribution:
# 
...
#This suggests your site experiences both moisture-limited and temperature-limited methane production, depending on conditions. 
...
# This supports your earlier findings about the complex interplay between temperature and moisture
...
```{r}
#interaction term in your ERA5 dataset, for reference: TS_SWC_interact

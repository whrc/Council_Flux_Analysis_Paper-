...
p_VPD_mk <- p_VPD_lm + labs(title = NULL)
p_rh_mk <- p_rh_lm + labs(title = NULL)
p_TA.TS <- p_TA.TS + theme(plot.title = element_blank())
...
p_TA_noleg <- p_TA.TS + labs(title = NULL) + theme(legend.position = "none")
p_SWC_noleg <- p_SWC_nf + labs(title = NULL) + theme(legend.position = "none")
p_VPD_noleg <- p_VPD_mk + labs(title = NULL) + theme(legend.position = "none")

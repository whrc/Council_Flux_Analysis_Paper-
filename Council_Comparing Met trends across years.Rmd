...
vpd_stats <- data.frame(
  ...
  kendall_p = c(0.017, 0.017, 0.017),
  kendall_tau = c(1.00, 0.87, 0.87),
...
rh_stats <- data.frame(
  ...
  kendall_p = c(0.017, 0.003, 0.003),
  kendall_tau = c(-1.00, -1.00, -1.00),
...
rh_stats <- rh_stats %>%
  mutate(label = paste0("adj R² = ", round(r2, 2), "\n",
                        ...
                        "Kendall_tau =", round(kendall_tau, 2), "\n",
                        "Kendall_p =", format.pval(kendall_p, digits = 4)))

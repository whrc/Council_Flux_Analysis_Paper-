...
# *** New datasets: calc prevailing WD for that day usng modal/frequency approach (similar to what wind roses use), then do a daily avg for data threshold of 50% across all variables --> create a df_avg for FC and FCH4 individually so lack to FCH4 doesn't affect potential days that could be used for FC --> to use these for stats 
...
#save new HH df with seasons added 
